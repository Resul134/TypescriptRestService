...
var url = "http://cars-rest.azurewebsites.net/api/Coins";
//FilterBud
var searchBid = document.getElementById("getSpecificCoin");
searchBid.addEventListener("click", budRange);
//FilterName
var searchnameButton = document.getElementById("søgNavnButton");
...
function addCoin() {
    var idinputElement = document.getElementById("addID");
    var genstandinputElement = document.getElementById("addGenstand");
    var budinputElement = document.getElementById("addBud");
    var navninputElement = document.getElementById("addNavn");
    var addoutputElement = document.getElementById("postOutput");
    var myID = Number(idinputElement.value);
    var myGenstand = genstandinputElement.value;
    var myBud = Number(budinputElement.value);
    var myNavn = navninputElement.value;
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.post(url, { Id: myID, Genstand: myGenstand, Bud: myBud, Navn: myNavn })
        .then(function (response) {
...
function deleteCoin() {
    ...
    var output = document.getElementById("deletedCoinOutput");
...
function budRange() {
    var filterElementoutput = document.getElementById("filterOutput");
    var inputFirstRange = document.getElementById("MinBud");
    var inputSecondRange = document.getElementById("MaxBud");
    var myMinYear = inputFirstRange.value;
    var myMaxYear = inputSecondRange.value;
    var urlFilterYear = url + "/" + "search?MinBud=" + myMinYear + "&&MaxBud=" + myMaxYear;
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get(urlFilterYear)
        .then(function (response) {
        var data = response.data;
        var longHtml3 = "<ol>";
        filterElementoutput.innerHTML = JSON.stringify(data);
        data.forEach(function (filterCoin) {
...
function searchbyName() {
    var inputName = document.getElementById("nameSearch");
    var MyName = inputName.value;
    var outputName = document.getElementById("filterName");
    var urlfilterName = url + "/" + "Name" + "/" + MyName;
    if (MyName.length > 0) {
        _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get(urlfilterName)
            .then(function (response) {
            var data = response.data;
            var longHtml3 = "<ol>";
...
function updateBid() {
    var updateBud = document.getElementById("updateBud");
    var updateNavn = document.getElementById("updateNavn");
    var id = document.getElementById("IDtoUpdate");
    var updatedOutput = document.getElementById("updateOutput");
    var chooseID = id.value;
    var updatedBud = updateBud.value;
    var updatedNavn = updateNavn.value;
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.put(url + "/" + chooseID, { Bud: updatedBud, Navn: updatedNavn })
        .then(function (response) {
